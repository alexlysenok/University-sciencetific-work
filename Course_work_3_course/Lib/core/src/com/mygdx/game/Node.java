...
abstract class Node extends Actor{
    ...
    protected float myXx ;                   // начальные координаты
    protected float myYy ;   
    protected int id; 
    protected float speedX;        // скорость по х
    protected float speedY;
    protected float xDestination;  // координата назначения
    protected float yDestination;
    protected float nextX;         // следующая координата посл текущей
    protected float nextY;         // следующая координата посл текущей
